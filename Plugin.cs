...
namespace Obeliskial_Options
{
    ...
    {
        private const string ModGUID = "com.meds.pissparty";
        private const string ModName = "Piss Party";
        ...
        {
            Log = base.Logger;
            Plugin.medsShopRarity = this.Config.Bind<bool>("Options", "Adjusted Shop Rarity", true, "Modify shop rarity by corruption. This makes the change in rarity from act 1 to 4 _slightly_ less abrupt.");
