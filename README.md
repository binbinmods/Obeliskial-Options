...
| **Bad Luck Protection**          | 100     | true        | Increases rarity of shop items based on number of shops seen without acquiring new items. Value x ShopsSeen x ActNumber / 100000=increased % mythic items.                     |
